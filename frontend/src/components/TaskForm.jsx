...
export default function TaskForm({ initialValues, onSave, onCancel, defaultDate, defaultListType, defaultContext, projects = [] }) {
    ...
    <form className="task-form" onSubmit={handleSubmit} noValidate>
      ...
      {showTwoMin && (
        <div className="two-min-rule">
          <Zap size={11} />
          <span>Two-minute rule — this is quick enough to do right now.</span>
        </div>
      )}
      ...
      <div className="task-form-row">
        <div className="form-group">
          <label htmlFor="tf-date">Date <span className="form-hint">(empty = unscheduled)</span></label>
